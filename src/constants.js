  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      .send(
        ...
        process.env.REACT_APP_EMAIL_JS_PUBLIC_KEY || "Bbwro6lQIIGADB9BE"
      )
      .then(
        () => {
          setLoading(false);
      ...
      <div className="text-white contact overflow-x-hidden pt-12 mt-8" id="contact">
        <div className="z-10 w-full sm:w-[650px] m-auto p-8 rounded-2xl">
          ...
          <form ref={formRef} onSubmit={handleSubmit} className="mt-12 flex flex-col gap-8">
            ...
            <button
              type="submit"
              className={`pt-3 px-8 rounded-xl outline-none w-fit font-bold shadow-md bg-gray-900 ${loading ? "opacity-50" : ""}`}
              disabled={loading}
            >
